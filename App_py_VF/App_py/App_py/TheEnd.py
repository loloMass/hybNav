...
def deltaInDistGrandeListe(longitudeListe,latitudeListe):
    ...
    deltaIndist=[6378 * 1000 * acos(
                ...
                cos(((longitudeListe[i][j] * pi) / 180) - ((longitudeListe[i][0] * pi) / 180)))  for i in range(0,len(latitudeListe)-1) for j in range(50,len(latitudeListe[i])) if j%50==0 and j is not 0]
...
#deltaInDistGrandeListe(longiintervalles,latintervalles)
